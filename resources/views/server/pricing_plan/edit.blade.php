            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-content">
                        <form action="{{ route('package.update',$package->id) }}" method="post" enctype="multipart/form-data"> @csrf @method('put')
                            <div class="card-body">
                                <div class="row">
                                 <div class="col-md-10">
                                        <fieldset class="mt-2">
                                        ...
                                        <fieldset class="mt-2">
                                            <h5>details</h5>
                                            <textarea name="details" id="description">{{$package->details}}</textarea>
                                        </fieldset>
