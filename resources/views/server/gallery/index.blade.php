                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h5 class="card-title">Gallery Image List</h5>
                            <div class="heading-elements">
                                <ul class="list-inline mb-0">
                                    <li class="ml-2"><a href="{{ route('gallery.create') }}" class="btn btn-primary">+ Create</a></li>
                                </ul>
                            </div>
                        </div>
                                        ...
                                        <tbody>
                                            @if ($galleries)
                                                @foreach ($galleries as $gallery)
                                                    <tr>
                                                        <td>@if ($gallery->service)
                                                            {{ $gallery->service->title }}
                                                        @endif</td>
                                                        <td><img src="{{ asset('images/gallery/'.$gallery->before) }}" alt="" height="150px" width="400"></td>
                                                        <td><img src="{{ asset('images/gallery/'.$gallery->after) }}" alt="" height="150px" width="400"></td>
                                                        
                                                        <td>
                                                            <div class="dropdown">
                                                                <span class="bx bx-dots-vertical-rounded font-medium-3 dropdown-toggle nav-hide-arrow cursor-pointer" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" role="menu"></span>
                                                                <div class="dropdown-menu dropdown-menu-right">
                                                                    <a class="dropdown-item" href="{{ route('gallery.edit',$gallery->id) }}"><i class="bx bx-edit-alt mr-1"></i> edit</a>
