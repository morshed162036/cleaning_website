                                    ...
                                    <div class="col-md-10">
                                        ...
                                        <fieldset class="mt-2">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <textarea class="form-control" id="basicTextarea" rows="3" placeholder="" name="first_text" required></textarea>
                                            </div>
                                        </fieldset>
                                        <fieldset class="mt-2">
                                            <h5>Second Text</h5>
                                            <div class="input-group">
                                                ...
                                                <textarea class="form-control" id="basicTextarea" rows="3" placeholder="" name="second_text" required></textarea>
                                            </div>
                                        </fieldset>
