            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-content">
                        <form action="{{ route('about_tab.update',$about_tab->id) }}" method="post" enctype="multipart/form-data"> @csrf @method('put')
                            <div class="card-body">
                                <div class="row">
                                   <div class="col-md-10">
                                        <fieldset class="mt-2">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="title" class="form-control" required value="{{ $about_tab->title }}">
                                            </div>
                                        </fieldset>
                                        <fieldset class="mt-2">
                                            <h5>order</h5>
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="order" class="form-control" value="{{ $about_tab->order }}">
                                            </div>
                                        </fieldset>
                                        <fieldset class="mt-2">
                                            <h5>Description</h5>
                                            <textarea name="description" id="description">{{ $about_tab->description }}</textarea>
                                        </fieldset>
