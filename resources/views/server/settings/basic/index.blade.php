                                ...
                                <div class="table-responsive">
                                    <table class="table zero-configuration">
                                        ...
                                        <tbody>
                                            @if ($detail)
                                                    <tr>
                                                        <td class="text-bold-600" > {{ $detail->name }}</td>
                                                        <td><img src="{{ asset('images/logo/'.$detail->logo) }}" alt="" height="100px" width="100px"></td>
                                                        <td><img src="{{ asset('images/logo/'.$detail->favicon) }}" alt="" height="50px" width="50px"></td>
                                                        <td>{{ $detail->address }}</td>
                                                        <td class="w-25">P: {{ $detail->phone }}<br>
                                                            E: {{ $detail->email }}<br>
                                                            @if ($detail->fax)
                                                               F: {{ $detail->fax }}
                                                            @endif
                                                        </td>
                                                        <td class="w-25">{{ $detail->operation_hour_1 }}<br>
                                                        ...
                                                        <td>
                                                            @if ($detail->facebook)
                                                               <i class="bx bxl-facebook"></i> {{ $detail->facebook }}
                                                            @endif <br>
                                                            @if ($detail->twitter)
                                                            <i class="bx bxl-twitter"></i> {{ $detail->twitter }}
                                                            @endif <br>
                                                            @if ($detail->instagram)
                                                            <i class="bx bxl-instagram"></i> {{ $detail->instagram }}
                                                            @endif <br>
                                                        </td>
                                                        <td>{{ $detail->google_location }}</td>
                                                        <td>
                                                            <div class="dropdown">
